  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md transition-all duration-300 ease-in-out">
        <h1 className="text-4xl font-extrabold text-gray-900 mb-4 leading-tight">{skill.name}</h1>
        <p className="text-lg text-gray-700 mb-6">{skill.description || 'No description provided.'}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div>
            ...
            <div className="space-y-2 text-gray-600">
              ...
              <p><strong>Author:</strong> {skill.author || skill.authorId || 'Unknown'}</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {skill.tags && skill.tags.length > 0 ? (
                ...
                <span className="px-3 py-1 text-sm font-medium bg-gray-100 text-gray-600 rounded-full">No Tags</span>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <pre className="bg-gray-50 p-4 rounded-md text-sm font-mono whitespace-pre-wrap break-words border border-gray-200">
            {skill.prompt || 'No prompt template provided.'}
          </pre>
        </div>
